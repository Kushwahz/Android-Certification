...
public class TopicD_1_CardView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_topic_d_1__card_view);

        mRecyclerView = findViewById(R.id.d1_recyclerView);
